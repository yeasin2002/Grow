  ...
  return (
    <View className={isLast ? "" : "border-b border-[#ededed] pb-6"}>
      <View className="flex-row items-center justify-between">
        <Text className="text-[16px] font-semibold tracking-[-0.24px] text-[#181818]">{title}</Text>
        <Text className="text-[16px] font-medium text-[#7e7e7e]">{progressText}</Text>
      </View>
      ...
      <Text className={`mt-2 text-[13px] font-medium ${statusColor}`}>{status}</Text>
    </View>
  );
}
