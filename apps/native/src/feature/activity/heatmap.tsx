...
const HEATMAP_ROWS: readonly HeatmapGraphRow[] = DAY_LABELS.map((day, rowIndex) => {
      ...
      <View style={{ width: heatmapWidth + 48 }}>
        ...
        <View className="mt-8 flex-row">
          <View className="mr-5 justify-between py-0.5">
            {DAY_LABELS.map((day) => (
              <View key={day} className="justify-center" style={{ height: cellSize }}>
                <Text className="text-[16px] font-medium text-[#b0b0b0]">{day}</Text>
              </View>
            ))}
          </View>
        ...
        <View className="mt-5 border-t border-[#ebebeb] pt-5">
          <View className="flex-row items-center justify-center">
            ...
            <Text className="text-[14px] font-medium text-[#7d7d7d]">Goal Not Meet</Text>
            <Text className="ml-8 text-[14px] font-medium text-[#7d7d7d]">Less</Text>
