  ...
  return (
    <View className="items-center">
      <View className="relative h-27 w-48">
        <HeroIconCard className="left-5 top-6 -rotate-2" icon="book-outline" iconSize={24} />
        <HeroIconCard
      ...
      <Text className="mt-1 text-[30px] font-bold tracking-[-0.8px] text-black">My Notes</Text>
