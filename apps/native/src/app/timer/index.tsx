        ...
        <View className="min-h-full justify-between">
          ...
          <View className="mt-14 rounded-[26px] bg-[#ececeb] px-4 pb-4 pt-4">
            <View className="flex-row items-center justify-center">
              <Icons className="mr-3 text-[#303030]" name="information-circle-outline" size={24} />
...
function TimerStatCard({ label, value }: TimerStatCardProps) {
  return (
    <View className="flex-1 items-center justify-center rounded-3xl bg-white px-5 py-4">
      ...
      <Text className="mt-2 text-[22px] font-bold tracking-[-0.5px] text-[#182033]">{value}</Text>
    </View>
  );
}
  ...
  return (
    <SafeAreaView edges={["top", "bottom"]}>
      <View className="items-center justify-center" style={{ width: size, height: size }}>
        ...
        >
          <Text className="text-[54px] font-bold tracking-[-2px] text-black">{TIMER_LABEL}</Text>
